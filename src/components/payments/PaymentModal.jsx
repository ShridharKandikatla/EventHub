...
const PaymentModal = ({ isOpen, onClose, event, ticketType, quantity = 1 }) => {
  ...
  const processingFee = Math.round((ticketPrice * quantity * 0.029 + 0.30) * 100) / 100;
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const intentResponse = await paymentAPI.createPaymentIntent(paymentIntentData);
      ...
      if (!selectedMethod) {
        ...
        const methodResponse = await paymentAPI.savePaymentMethod(paymentMethodData);
